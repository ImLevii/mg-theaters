...
const HeroSwiper = () => {
    ...
    return (
        <div className={cn("relative h-[60vh] md:h-[707px] max-h-[85vh] w-full md:w-[1250px] max-w-[calc(100%-32px)] md:max-w-full overflow-hidden group rounded-3xl shadow-2xl shadow-black/50 mx-auto bg-black")}>
            <Swiper
                spaceBetween={0}
                effect={"fade"}
                grabCursor={true}
